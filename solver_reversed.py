#!/usr/bin/env python3
"""
HuragokForce2 — Substitution cipher solver for Halo subglyphs (REVERSED).

In Sadie's Story, some frames appear warped/mirrored when Vergil is
"corrupted", so the sequence might need to be read in reverse:
  Original: 0  1  E  3  4  0  5  6  E  7  5  3  E  E  7  8  E  9  E
  Reversed: E  9  E  8  7  E  E  3  5  7  E  6  5  0  4  3  E  1  0
...
GLYPH_SEQUENCE = ['E', '9', 'E', '8', '7', 'E', 'E', '3', '5',
                   '7', 'E', '6', '5', '0', '4', '3', 'E', '1', '0']
...
def main():
    print("=" * 70)
    print("HuragokForce2 — Substitution Cipher Solver (REVERSED)")
    print("=" * 70)
    print()
    ...
    outpath = Path(__file__).parent / 'results_reversed.txt'
    with open(outpath, 'w') as f:
        f.write(f"HuragokForce2 Results (REVERSED) — {len(unique)} unique segmentations\n")
        f.write("=" * 70 + "\n\n")
